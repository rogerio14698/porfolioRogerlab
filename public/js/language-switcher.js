(function () {
    ...
    var translations = {
        es: {
            'nav.home': 'Inicio',
            'nav.about': 'Sobre mi',
            'nav.fct': 'Practicas FCT',
            'nav.articles': 'Articulos',
            'nav.projects': 'Proyectos',
            'nav.juegos': 'Juegos JavaScript',
            'nav.contact': 'Contacto',
            'practicas.modal.title': 'Seguimiento detallado de practicas:',
            ...
            'articles.scaling.title': 'Menos picar codigo, mas soluciones que escalan',
            'articles.scaling.intro': 'Escalar no consiste en producir mas lineas de codigo, sino en resolver mejor los problemas que importan al negocio y al usuario.',
            'articles.scaling.item_1': 'Empieza por el problema: antes de programar, define con precision el objetivo, la restriccion y la metrica de exito.',
            'articles.scaling.item_2': 'Disena arquitectura simple: prefiere soluciones claras, modulares y faciles de mantener frente a complejidad innecesaria.',
            ...
            'articles.scaling.item_4': 'Mide antes de optimizar: usa datos reales de rendimiento y uso para decidir que mejorar primero.',
            'articles.scaling.item_5': 'Piensa en equipo: documentacion, convenciones y codigo legible aceleran la colaboracion y evitan deuda tecnica.',
            'articles.scaling.note': 'Cuando el foco pasa de picar codigo a entregar valor, el software escala mejor en calidad, velocidad de entrega y experiencia de usuario.',
        ...
        pt: {
            ...
            'nav.contact': 'Contacto',
            'practicas.modal.title': 'Acompanhamento detalhado do estagio:',
            ...
            'articles.scaling.title': 'Menos picar codigo, mais solucoes que escalam',
            'articles.scaling.intro': 'Escalar nao e produzir mais linhas de codigo, mas sim resolver melhor os problemas que realmente importam para o negocio e para o utilizador.',
            'articles.scaling.item_1': 'Comeca pelo problema: antes de programar, define com clareza o objetivo, as restricoes e a metrica de sucesso.',
            'articles.scaling.item_2': 'Desenha arquitetura simples: prefere solucoes claras, modulares e faceis de manter em vez de complexidade desnecessaria.',
            'articles.scaling.item_3': 'Automatiza o repetivel: CI/CD, testes e validacoes reduzem erros e permitem iterar com confianca.',
            'articles.scaling.item_4': 'Mede antes de otimizar: usa dados reais de desempenho e uso para decidir o que melhorar primeiro.',
            'articles.scaling.item_5': 'Pensa em equipa: documentacao, convencoes e codigo legivel aceleram a colaboracao e evitam divida tecnica.',
            'articles.scaling.note': 'Quando o foco muda de picar codigo para entregar valor, o software escala melhor em qualidade, velocidade de entrega e experiencia do utilizador.',
