(function () {
    ...
    var translations = {
        es: {
            ...
            'projects.n8n-linkedin.body_1': 'Proyecto de automatización de búsqueda de empleos en n8n, en el cual hice un flujo de trabajo en el cual se realiza búsquedas de empleos en Linkedin via browsless, y mediante código extrae lo necesario para que luego puedas aplicar a esa oferta.\n\nTambién implementé un filtro match score en el flujo para priorizar las ofertas que mejor se ajusten a los datos del CV.\n\nEl proyecto también incluye la integración de APIs de Google Drive, Google Sheets y Google Docs, para almacenar, organizar datos y generar cartas de presentación personalizadas para cada oferta de empleo. Permitiendo un aplicar a ofertas de manera más eficiente y rápida. Sin perder la profesionalidad y personalización en el proceso de aplicación.',
            'projects.n8n-linkedin.body_2': 'Captura del proyecto N8n LinkedIn Workflow Búsqueda Empleo',
        ...
        en: {
            ...
            'projects.n8n-linkedin.body_1': 'Job search automation project in n8n featuring a workflow that searches job postings on LinkedIn via Browserless, extracting essential data using code so you can easily apply.\n\nI also implemented a match score filter in the workflow to prioritize job offers that best align with CV data.\n\nThe project includes integrating Google Drive, Google Sheets, and Google Docs APIs to store and organize data, as well as generate personalized cover letters for each job offer, enabling faster and more efficient applications while preserving professionalism.',
            'projects.n8n-linkedin.body_2': 'Screenshot of N8n LinkedIn Job Search Workflow project',
        ...
        pt: {
            ...
            'projects.n8n-linkedin.body_1': 'Projeto de automação de busca de empregos no n8n, no qual criei um fluxo de trabalho que realiza pesquisas de emprego no LinkedIn via Browserless e extrai o necessário via código para facilitar a candidatura.\n\nTambém implementei um filtro de pontuação de compatibilidade (match score) para priorizar as ofertas mais alinhadas com os dados do CV.\n\nO projeto inclui ainda a integração das APIs do Google Drive, Google Sheets e Google Docs para armazenar, organizar dados e gerar cartas de apresentação personalizadas para cada vaga, permitindo candidaturas mais rápidas e eficientes sem perder o profissionalismo.',
            'projects.n8n-linkedin.body_2': 'Captura do projeto N8n LinkedIn Workflow Busca Emprego',
