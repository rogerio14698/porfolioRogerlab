(function () {
    ...
    var translations = {
        es: {
            ...
            'about.methodology.body_1': ' No me limito a escribir código; me gusta entender el "porqué" de cada solución.Intento seguir buenas prácticas como el desarrollo de código limpio (Clean Code)y me enfoco en crear soluciones que sean escalables y fáciles de mantener.',
            ...
            'about.specialization.body_1': 'Ahora estoy aprofundizando en Laravel, quiero empezar a trabajar con el e-commerce de Laravel y con Laravel Spark. También me está llamando la atención el mundo del hacking ético y la seguridad.Por otro lado, escapando de la programación web, me esta interesando el mundo de la seguridad en RFID, NFC y hadware hacking de forma práctica, técnica y aplicable.',
            'about.specialization.body_2': 'Mi objetivo a corto plazo es dominar el despliegue de aplicaciones en la nube, aprofundiar en Laravel Y buscar colaboraciónes en proyectos que me parezcan interesantes.',
        ...
        en: {
            ...
            'about.methodology.body_1': `I don't just write code; I like to understand the "why" behind each solution. I try to follow best practices like clean code development, and I focus on creating solutions that are scalable and easy to maintain.`, 
            ...
            'about.specialization.body_1': `I'm now delving deeper into Laravel; I want to start working with Laravel e-commerce and Laravel Spark. I'm also becoming interested in the world of ethical hacking and security.On the other hand, moving away from web programming, I'm becoming interested in the world of RFID, NFC, and hardware hacking security in a practical, technical, and applicable way.`,
            'about.specialization.body_2': `My short-term goal is to master cloud application deployment, delve deeper into Laravel, and seek collaborations on projects that interest me.`,
        ...
        pt: {
            ...
            'about.methodology.body_1': `Eu não me limito a escrever código; gosto de entender o "porquê" por trás de cada solução. Procuro seguir as melhores práticas, como o desenvolvimento de código limpo, e foco na criação de soluções escaláveis ​​e fáceis de manter.`,
            ...
            'about.specialization.body_1': `Estou me aprofundando no Laravel; quero começar a trabalhar com e-commerce em Laravel e Laravel Spark. Também estou me interessando pelo mundo do hacking ético e da segurança cibernética. Por outro lado, deixando de lado a programação web, estou me interessando pelo mundo da RFID, NFC e segurança de hardware de uma forma prática, técnica e aplicável.`,
            'about.specialization.body_2': 'Meu objetivo a curto prazo é dominar a implantação de aplicações em nuvem, aprofundar meus conhecimentos em Laravel e buscar colaborações em projetos que me interessem.',
