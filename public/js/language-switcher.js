(function () {
    ...
    var translations = {
        es: {
            ...
            'projects.apipokemon.body_1': 'Proyecto centrado en integración de API REST con Laravel: diseñé rutas limpias, validación de búsqueda por nombre o ID y un controlador que consume PokeAPI para construir una ficha completa del Pokemon.',
            'projects.apipokemon.body_2': 'Apliqué tratamiento de datos anidados para extraer sprites normales y shiny, separación por componentes Blade y lógica de interfaz para filtrar galerías, manteniendo una experiencia rápida, clara y mantenible.',
        ...
        en: {
            ...
            'projects.apipokemon.body_1': 'Project focused on REST API integration with Laravel: I designed clean routes, search validation by name or ID, and a controller that consumes PokeAPI to build a complete Pokemon sheet.',
            'projects.apipokemon.body_2': 'I applied nested-data processing to extract normal and shiny sprites, Blade component separation, and UI filtering logic for galleries, keeping the experience fast, clear, and maintainable.',
        ...
        pt: {
            ...
            'projects.apipokemon.body_1': 'Projeto focado na integração de API REST com Laravel: desenhei rotas limpas, validação de pesquisa por nome ou ID e um controlador que consome a PokeAPI para montar uma ficha completa do Pokemon.',
            'projects.apipokemon.body_2': 'Apliquei tratamento de dados aninhados para extrair sprites normais e shiny, separação por componentes Blade e lógica de interface para filtrar galerias, mantendo uma experiência rápida, clara e sustentável.',
