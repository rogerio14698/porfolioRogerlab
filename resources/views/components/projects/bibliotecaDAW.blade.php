<div class="cardProject">
        <div class="logo">
            <img src="{{asset('img/logoDAW-conTransparencia.png')}}" alt="Logo del proyecto Biblioteca DAW" data-i18n-alt="projects.library.alt">
        </div>
        ...
        <div class="description">
            <p data-i18n="projects.library.body_1">It was my final project for the DAW (Desarrollo de Aplicaciones Web) module. 
